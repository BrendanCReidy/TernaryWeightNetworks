...
parser.add_argument('--history-file', "--hf", dest='history_file',
                    ...
                    type=str, default="mnist_train_history")
best_prec1 = 0
def main():
    ...
    macs, params = thop_profile(model, inputs=(x,))
    model_params["macs"] = macs
    ...
    for epoch in range(0, args.epochs):
        ...
        epoch_data = {"best_top1":best_prec1, "train_top1":train_top1,
            "val_top1":prec1, "train_loss":train_loss, "val_loss":val_loss,
            "lr":optimizer.param_groups[0]['lr']}

        for key in model_params.keys():
            epoch_data[key] = model_params[key]

        out_data.append(epoch_data)
...
def train(train_loader, model, criterion, optimizer, epoch):
    ...
    return top1.avg, loss.to(torch.device('cpu')).item()
